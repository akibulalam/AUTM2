...
<section id="home", class="home">
	...
	<div class="container">
		<div class="row">
			<div class="col-25">
		        <label for="comment" style="color: white;"><h4><b>Comment</b></h4></label>
		     </div>
			<div class="col-75">
        		<textarea id="comment" name="comment" style="height:200px; width:500px;" ><?php echo $s;?></textarea>
      		</div>
		...
		<div class="row">
			<div class="col-25">
		        <label for="circular" style="color: white;"><h4><b>Comments</b></h4></label>
		     </div>
			<div class="col-75">
...
<input type="submit" value="seen" id ="butt">
</div>
