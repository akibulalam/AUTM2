...
<div class="form-control centre">
	...
	<table style="width: 80%">
			...
			<tr>
				<th>Appointment :</th>
				<td><input class="form-control" type="text" name="Appointment"> <br></td>
			</tr>
			<tr>
				<th>Qualification : </th>
			...
			<tr>
				<th>Joining Date : </th>
				<td><input class="form-control" type="text" name="Joining_Date"> <br></td>
			</tr>
			<tr>
				<th>Last Date : </th>
				<td><input class="form-control" type="text" name="Last_Date"> <br></td>
			</tr>
