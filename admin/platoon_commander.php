<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['application'])){
		$data = $_POST;
		$done = $cls->platoon_commander($data);
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="form-control centre">
	...
	<table style="width: 80%">
			...
			<tr>
				<th>Platoon No. :</th>
				<td><input class="form-control" type="text" name="p_no"> <br></td>
			</tr>
			<tr>
				<th>Joining Date : </th>
			...
			<tr>
				<th>DOP : </th>
				<td><input class="form-control" type="text" name="dop"> <br></td>
			</tr>
			<tr>
				<th>Platoon No. : </th>
				<td><input class="form-control" type="text" name="platoon_NO"> <br></td>
			</tr>
