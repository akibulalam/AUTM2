...
<div class="form-control centre">
	...
	<table style="width: 80%">
			...
			<tr>
				<th>Arms or Civilian : </th>
				<td><input class="form-control" type="text" name="Arms_or_Civilian"> <br></td>
			</tr>
			<tr>
				<th>Post : </th>
			...
			<tr>
				<th>Joining Date : </th>
				<td><input class="form-control" type="date" name="Joining_Date"> <br></td>
			</tr>
			<tr>
				<th>Qualification : </th>
				<td><input class="form-control" type="text" name="Qualification"> <br></td>
			</tr>
			<tr>
				<th>Organisation : </th>
				<td><input class="form-control" type="text" name="Organisation"> <br></td>
			</tr>
			<tr>
			...
			<tr>
				<th>Salary : </th>
				<td><input class="form-control" type="text" name="Salary"> <br></td>
			</tr>
