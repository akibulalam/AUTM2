...
<div class="form-control centre">
	...
	<table style="width: 80%">
			...
			<tr>
				<th>Subject Code :</th>
				<td><input class="form-control" type="text" name="subject_code"> <br></td>
			</tr>
			<tr>
				<th>Type : </th>
			...
			<tr>
				<th>Duration : </th>
				<td><input class="form-control" type="text" name="duration"> <br></td>
			</tr>
			<tr>
				<th>Syllabus: </th>
				<td><input class="form-control" type="text" name="syllabus"> <br></td>
			</tr>
