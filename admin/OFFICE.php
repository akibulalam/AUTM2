...
<div class="form-control centre">
	...
	<table style="width: 80%">
			...
			<tr>
				<th>Registration Sequence :</th>
				<td><input class="form-control" type="text" name="Regt_Sqn_Flotilla"> <br></td>
			</tr>
			<tr>
				<th>Institute : </th>
				<td><input class="form-control" type="text" name="Institute"> <br></td>
			</tr>
			<tr>
				<th>Battalion : </th>
				<td><input class="form-control" type="text" name="Battalion"> <br></td>
			</tr>
