...
<div class="form-control centre">
	...
	<table style="width: 80%">
			<tr>
				<th>Item name : </th>
				<td><input class="form-control" type="text" name="ITEM_NAME"> <br></td>
			</tr>
			<tr>
				<th>Item amount :</th>
				<td><input class="form-control" type="text" name="ITEM_AMOUNT"> <br></td>
			</tr>
			<tr>
				<th>Item Code : </th>
				<td><input class="form-control" type="text" name="ITEM_CODE"> <br></td>
			</tr>
			<tr>
				<th>Issued By : </th>
				<td><input class="form-control" type="text" name="ISSUED_BY"> <br></td>
			</tr>
			<tr>
				<th>Item Office : </th>
				<td><input class="form-control" type="text" name="ITEM_OFFICE"> <br></td>
			</tr>
			<tr>
				<th>Item Type : </th>
				<td><input class="form-control" type="text" name="ITEM_TYPE"> <br></td>
			</tr>
