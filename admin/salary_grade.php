...
<div class="form-control centre">
	...
	<table style="width: 80%">
			<tr>
				<th>Grade : </th>
				<td><input class="form-control" type="text" name="grade"> <br></td>
			</tr>
			<tr>
				<th>Hisal :</th>
				<td><input class="form-control" type="text" name="hisal"> <br></td>
			</tr>
			<tr>
				<th>Lowsal : </th>
				<td><input class="form-control" type="email" name="lowsal"> <br></td>
			</tr>
